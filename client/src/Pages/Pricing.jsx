...
function PricingCard({
  title,price,amount,credits,description,features,popular,selectedPrice,setSelectedPrice,onBuy,paying,payingAmount
}){
  ...
  return (
    ...
    whileHover={{y:-4}}
    className= {`relative cursor-pointer rounded p-6 bg-white border transition ${isSelected?"border-black":popular?"border-indigo-500":"border-gray-200"}`}
    >
      ...
      >
        {isPayingThisCard? "Redirecting...":"Buy"}
      </button>
